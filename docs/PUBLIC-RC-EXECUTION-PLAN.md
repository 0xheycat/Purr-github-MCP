...
**G1.3 — Replace owner-code authorization and global `OAUTH_SUBJECT` identity with authenticated GitHub user sessions, without yet expanding into GitHub App installation selection.**
